...
// AwsSagemakerHumanTaskUIInvalidTagsRule validates map keys and values
type AwsSagemakerHumanTaskUIInvalidTagsRule struct {
	tflint.DefaultRule
...
// NewAwsSagemakerHumanTaskUIInvalidTagsRule returns new rule with default attributes
func NewAwsSagemakerHumanTaskUIInvalidTagsRule() *AwsSagemakerHumanTaskUIInvalidTagsRule {
	return &AwsSagemakerHumanTaskUIInvalidTagsRule{
...
func (r *AwsSagemakerHumanTaskUIInvalidTagsRule) Name() string {
	return "aws_sagemaker_human_task_ui_invalid_tags"
}

// Enabled returns whether the rule is enabled by default
func (r *AwsSagemakerHumanTaskUIInvalidTagsRule) Enabled() bool {
	return true
}

// Severity returns the rule severity
func (r *AwsSagemakerHumanTaskUIInvalidTagsRule) Severity() tflint.Severity {
	return tflint.ERROR
}

// Link returns the rule reference link
func (r *AwsSagemakerHumanTaskUIInvalidTagsRule) Link() string {
	return ""
}

// Check validates map keys and values
func (r *AwsSagemakerHumanTaskUIInvalidTagsRule) Check(runner tflint.Runner) error {
