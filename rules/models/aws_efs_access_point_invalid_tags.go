...
// NewAwsEfsAccessPointInvalidTagsRule returns new rule with default attributes
func NewAwsEfsAccessPointInvalidTagsRule() *AwsEfsAccessPointInvalidTagsRule {
	return &AwsEfsAccessPointInvalidTagsRule{
...
func (r *AwsEfsAccessPointInvalidTagsRule) Name() string {
	return "aws_efs_access_point_invalid_tags"
}

// Enabled returns whether the rule is enabled by default
func (r *AwsEfsAccessPointInvalidTagsRule) Enabled() bool {
	return true
}

// Severity returns the rule severity
func (r *AwsEfsAccessPointInvalidTagsRule) Severity() tflint.Severity {
	return tflint.ERROR
}

// Link returns the rule reference link
func (r *AwsEfsAccessPointInvalidTagsRule) Link() string {
	return ""
}
