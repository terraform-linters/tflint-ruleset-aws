...
// AwsEcsServiceInvalidTagsRule validates map keys and values
type AwsEcsServiceInvalidTagsRule struct {
	tflint.DefaultRule
...
// NewAwsEcsServiceInvalidTagsRule returns new rule with default attributes
func NewAwsEcsServiceInvalidTagsRule() *AwsEcsServiceInvalidTagsRule {
	return &AwsEcsServiceInvalidTagsRule{
...
func (r *AwsEcsServiceInvalidTagsRule) Name() string {
	return "aws_ecs_service_invalid_tags"
}

// Enabled returns whether the rule is enabled by default
func (r *AwsEcsServiceInvalidTagsRule) Enabled() bool {
	return true
}

// Severity returns the rule severity
func (r *AwsEcsServiceInvalidTagsRule) Severity() tflint.Severity {
	return tflint.ERROR
}

// Link returns the rule reference link
func (r *AwsEcsServiceInvalidTagsRule) Link() string {
	return ""
}

// Check validates map keys and values
func (r *AwsEcsServiceInvalidTagsRule) Check(runner tflint.Runner) error {
