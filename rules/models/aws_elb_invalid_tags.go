...
// AwsELBInvalidTagsRule validates map keys and values
type AwsELBInvalidTagsRule struct {
	tflint.DefaultRule
...
// NewAwsELBInvalidTagsRule returns new rule with default attributes
func NewAwsELBInvalidTagsRule() *AwsELBInvalidTagsRule {
	return &AwsELBInvalidTagsRule{
...
func (r *AwsELBInvalidTagsRule) Name() string {
	return "aws_elb_invalid_tags"
}

// Enabled returns whether the rule is enabled by default
func (r *AwsELBInvalidTagsRule) Enabled() bool {
	return true
}

// Severity returns the rule severity
func (r *AwsELBInvalidTagsRule) Severity() tflint.Severity {
	return tflint.ERROR
}

// Link returns the rule reference link
func (r *AwsELBInvalidTagsRule) Link() string {
	return ""
}

// Check validates map keys and values
func (r *AwsELBInvalidTagsRule) Check(runner tflint.Runner) error {
