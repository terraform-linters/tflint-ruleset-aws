...
func NewAwsServicecatalogServiceActionInvalidNameRule() *AwsServicecatalogServiceActionInvalidNameRule {
	return &AwsServicecatalogServiceActionInvalidNameRule{
...
func (r *AwsServicecatalogServiceActionInvalidNameRule) Name() string {
	return "aws_servicecatalog_service_action_invalid_name"
}
...
func (r *AwsServicecatalogServiceActionInvalidNameRule) Severity() string {
	return tflint.ERROR
}
