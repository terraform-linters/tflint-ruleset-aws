...
// AwsLbInvalidTagsRule validates map keys and values
type AwsLbInvalidTagsRule struct {
	tflint.DefaultRule
...
// NewAwsLbInvalidTagsRule returns new rule with default attributes
func NewAwsLbInvalidTagsRule() *AwsLbInvalidTagsRule {
	return &AwsLbInvalidTagsRule{
		resourceType:  "aws_lb",
		attributeName: "tags",
		keyMax:        128,
		keyMin:        1,
...
func (r *AwsLbInvalidTagsRule) Name() string {
	return "aws_lb_invalid_tags"
}

// Enabled returns whether the rule is enabled by default
func (r *AwsLbInvalidTagsRule) Enabled() bool {
	return true
}

// Severity returns the rule severity
func (r *AwsLbInvalidTagsRule) Severity() tflint.Severity {
	return tflint.ERROR
}

// Link returns the rule reference link
func (r *AwsLbInvalidTagsRule) Link() string {
	return ""
}

// Check validates map keys and values
func (r *AwsLbInvalidTagsRule) Check(runner tflint.Runner) error {
