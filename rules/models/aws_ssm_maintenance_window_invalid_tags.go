...
// NewAwsSsmMaintenanceWindowInvalidTagsRule returns new rule with default attributes
func NewAwsSsmMaintenanceWindowInvalidTagsRule() *AwsSsmMaintenanceWindowInvalidTagsRule {
	return &AwsSsmMaintenanceWindowInvalidTagsRule{
...
func (r *AwsSsmMaintenanceWindowInvalidTagsRule) Name() string {
	return "aws_ssm_maintenance_window_invalid_tags"
}

// Enabled returns whether the rule is enabled by default
func (r *AwsSsmMaintenanceWindowInvalidTagsRule) Enabled() bool {
	return true
}

// Severity returns the rule severity
func (r *AwsSsmMaintenanceWindowInvalidTagsRule) Severity() tflint.Severity {
	return tflint.ERROR
}

// Link returns the rule reference link
func (r *AwsSsmMaintenanceWindowInvalidTagsRule) Link() string {
	return ""
}
