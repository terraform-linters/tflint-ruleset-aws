...
// AwsWafv2RuleGroupInvalidTagsRule validates map keys and values
type AwsWafv2RuleGroupInvalidTagsRule struct {
	tflint.DefaultRule
...
// NewAwsWafv2RuleGroupInvalidTagsRule returns new rule with default attributes
func NewAwsWafv2RuleGroupInvalidTagsRule() *AwsWafv2RuleGroupInvalidTagsRule {
	return &AwsWafv2RuleGroupInvalidTagsRule{
...
func (r *AwsWafv2RuleGroupInvalidTagsRule) Name() string {
	return "aws_wafv2_rule_group_invalid_tags"
}

// Enabled returns whether the rule is enabled by default
func (r *AwsWafv2RuleGroupInvalidTagsRule) Enabled() bool {
	return true
}

// Severity returns the rule severity
func (r *AwsWafv2RuleGroupInvalidTagsRule) Severity() tflint.Severity {
	return tflint.ERROR
}

// Link returns the rule reference link
func (r *AwsWafv2RuleGroupInvalidTagsRule) Link() string {
	return ""
}

// Check validates map keys and values
func (r *AwsWafv2RuleGroupInvalidTagsRule) Check(runner tflint.Runner) error {
