...
// AwsSagemakerEndpointInvalidTagsRule validates map keys and values
type AwsSagemakerEndpointInvalidTagsRule struct {
	tflint.DefaultRule
...
// NewAwsSagemakerEndpointInvalidTagsRule returns new rule with default attributes
func NewAwsSagemakerEndpointInvalidTagsRule() *AwsSagemakerEndpointInvalidTagsRule {
	return &AwsSagemakerEndpointInvalidTagsRule{
...
func (r *AwsSagemakerEndpointInvalidTagsRule) Name() string {
	return "aws_sagemaker_endpoint_invalid_tags"
}

// Enabled returns whether the rule is enabled by default
func (r *AwsSagemakerEndpointInvalidTagsRule) Enabled() bool {
	return true
}

// Severity returns the rule severity
func (r *AwsSagemakerEndpointInvalidTagsRule) Severity() tflint.Severity {
	return tflint.ERROR
}

// Link returns the rule reference link
func (r *AwsSagemakerEndpointInvalidTagsRule) Link() string {
	return ""
}

// Check validates map keys and values
func (r *AwsSagemakerEndpointInvalidTagsRule) Check(runner tflint.Runner) error {
