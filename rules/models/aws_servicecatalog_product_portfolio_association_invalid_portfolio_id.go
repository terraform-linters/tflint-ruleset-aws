...
func (r *AwsServicecatalogProductPortfolioAssociationInvalidPortfolioIDRule) Name() string {
	return "aws_servicecatalog_product_portfolio_association_invalid_portfolio_id"
}
...
func (r *AwsServicecatalogProductPortfolioAssociationInvalidPortfolioIDRule) Severity() string {
	return tflint.ERROR
}
