...
// NewAwsEfsFileSystemInvalidTagsRule returns new rule with default attributes
func NewAwsEfsFileSystemInvalidTagsRule() *AwsEfsFileSystemInvalidTagsRule {
	return &AwsEfsFileSystemInvalidTagsRule{
...
func (r *AwsEfsFileSystemInvalidTagsRule) Name() string {
	return "aws_efs_file_system_invalid_tags"
}

// Enabled returns whether the rule is enabled by default
func (r *AwsEfsFileSystemInvalidTagsRule) Enabled() bool {
	return true
}

// Severity returns the rule severity
func (r *AwsEfsFileSystemInvalidTagsRule) Severity() tflint.Severity {
	return tflint.ERROR
}

// Link returns the rule reference link
func (r *AwsEfsFileSystemInvalidTagsRule) Link() string {
	return ""
}
