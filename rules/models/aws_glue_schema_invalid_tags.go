...
// NewAwsGlueSchemaInvalidTagsRule returns new rule with default attributes
func NewAwsGlueSchemaInvalidTagsRule() *AwsGlueSchemaInvalidTagsRule {
	return &AwsGlueSchemaInvalidTagsRule{
...
func (r *AwsGlueSchemaInvalidTagsRule) Name() string {
	return "aws_glue_schema_invalid_tags"
}

// Enabled returns whether the rule is enabled by default
func (r *AwsGlueSchemaInvalidTagsRule) Enabled() bool {
	return true
}

// Severity returns the rule severity
func (r *AwsGlueSchemaInvalidTagsRule) Severity() tflint.Severity {
	return tflint.ERROR
}

// Link returns the rule reference link
func (r *AwsGlueSchemaInvalidTagsRule) Link() string {
	return ""
}
