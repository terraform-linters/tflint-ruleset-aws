...
// AwsFsxOntapVolumeInvalidTagsRule validates map keys and values
type AwsFsxOntapVolumeInvalidTagsRule struct {
	tflint.DefaultRule
...
// NewAwsFsxOntapVolumeInvalidTagsRule returns new rule with default attributes
func NewAwsFsxOntapVolumeInvalidTagsRule() *AwsFsxOntapVolumeInvalidTagsRule {
	return &AwsFsxOntapVolumeInvalidTagsRule{
...
func (r *AwsFsxOntapVolumeInvalidTagsRule) Name() string {
	return "aws_fsx_ontap_volume_invalid_tags"
}

// Enabled returns whether the rule is enabled by default
func (r *AwsFsxOntapVolumeInvalidTagsRule) Enabled() bool {
	return true
}

// Severity returns the rule severity
func (r *AwsFsxOntapVolumeInvalidTagsRule) Severity() tflint.Severity {
	return tflint.ERROR
}

// Link returns the rule reference link
func (r *AwsFsxOntapVolumeInvalidTagsRule) Link() string {
	return ""
}

// Check validates map keys and values
func (r *AwsFsxOntapVolumeInvalidTagsRule) Check(runner tflint.Runner) error {
