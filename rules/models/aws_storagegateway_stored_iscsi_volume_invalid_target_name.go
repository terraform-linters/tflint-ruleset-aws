...
func NewAwsStoragegatewayStoredIscsiVolumeInvalidTargetNameRule() *AwsStoragegatewayStoredIscsiVolumeInvalidTargetNameRule {
	return &AwsStoragegatewayStoredIscsiVolumeInvalidTargetNameRule{
...
func (r *AwsStoragegatewayStoredIscsiVolumeInvalidTargetNameRule) Name() string {
	return "aws_storagegateway_stored_iscsi_volume_invalid_target_name"
}
...
func (r *AwsStoragegatewayStoredIscsiVolumeInvalidTargetNameRule) Severity() string {
	return tflint.ERROR
}
