...
// AwsSagemakerAppInvalidTagsRule validates map keys and values
type AwsSagemakerAppInvalidTagsRule struct {
	tflint.DefaultRule
...
// NewAwsSagemakerAppInvalidTagsRule returns new rule with default attributes
func NewAwsSagemakerAppInvalidTagsRule() *AwsSagemakerAppInvalidTagsRule {
	return &AwsSagemakerAppInvalidTagsRule{
...
func (r *AwsSagemakerAppInvalidTagsRule) Name() string {
	return "aws_sagemaker_app_invalid_tags"
}

// Enabled returns whether the rule is enabled by default
func (r *AwsSagemakerAppInvalidTagsRule) Enabled() bool {
	return true
}

// Severity returns the rule severity
func (r *AwsSagemakerAppInvalidTagsRule) Severity() tflint.Severity {
	return tflint.ERROR
}

// Link returns the rule reference link
func (r *AwsSagemakerAppInvalidTagsRule) Link() string {
	return ""
}

// Check validates map keys and values
func (r *AwsSagemakerAppInvalidTagsRule) Check(runner tflint.Runner) error {
