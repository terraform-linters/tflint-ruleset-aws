...
// AwsSagemakerUserProfileInvalidTagsRule validates map keys and values
type AwsSagemakerUserProfileInvalidTagsRule struct {
	tflint.DefaultRule
...
// NewAwsSagemakerUserProfileInvalidTagsRule returns new rule with default attributes
func NewAwsSagemakerUserProfileInvalidTagsRule() *AwsSagemakerUserProfileInvalidTagsRule {
	return &AwsSagemakerUserProfileInvalidTagsRule{
...
func (r *AwsSagemakerUserProfileInvalidTagsRule) Name() string {
	return "aws_sagemaker_user_profile_invalid_tags"
}

// Enabled returns whether the rule is enabled by default
func (r *AwsSagemakerUserProfileInvalidTagsRule) Enabled() bool {
	return true
}

// Severity returns the rule severity
func (r *AwsSagemakerUserProfileInvalidTagsRule) Severity() tflint.Severity {
	return tflint.ERROR
}

// Link returns the rule reference link
func (r *AwsSagemakerUserProfileInvalidTagsRule) Link() string {
	return ""
}

// Check validates map keys and values
func (r *AwsSagemakerUserProfileInvalidTagsRule) Check(runner tflint.Runner) error {
