...
// AwsEcsTaskDefinitionInvalidTagsRule validates map keys and values
type AwsEcsTaskDefinitionInvalidTagsRule struct {
	tflint.DefaultRule
...
// NewAwsEcsTaskDefinitionInvalidTagsRule returns new rule with default attributes
func NewAwsEcsTaskDefinitionInvalidTagsRule() *AwsEcsTaskDefinitionInvalidTagsRule {
	return &AwsEcsTaskDefinitionInvalidTagsRule{
...
func (r *AwsEcsTaskDefinitionInvalidTagsRule) Name() string {
	return "aws_ecs_task_definition_invalid_tags"
}

// Enabled returns whether the rule is enabled by default
func (r *AwsEcsTaskDefinitionInvalidTagsRule) Enabled() bool {
	return true
}

// Severity returns the rule severity
func (r *AwsEcsTaskDefinitionInvalidTagsRule) Severity() tflint.Severity {
	return tflint.ERROR
}

// Link returns the rule reference link
func (r *AwsEcsTaskDefinitionInvalidTagsRule) Link() string {
	return ""
}

// Check validates map keys and values
func (r *AwsEcsTaskDefinitionInvalidTagsRule) Check(runner tflint.Runner) error {
