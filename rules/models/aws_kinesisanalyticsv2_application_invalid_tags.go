...
// NewAwsKinesisanalyticsv2ApplicationInvalidTagsRule returns new rule with default attributes
func NewAwsKinesisanalyticsv2ApplicationInvalidTagsRule() *AwsKinesisanalyticsv2ApplicationInvalidTagsRule {
	return &AwsKinesisanalyticsv2ApplicationInvalidTagsRule{
...
func (r *AwsKinesisanalyticsv2ApplicationInvalidTagsRule) Name() string {
	return "aws_kinesisanalyticsv2_application_invalid_tags"
}

// Enabled returns whether the rule is enabled by default
func (r *AwsKinesisanalyticsv2ApplicationInvalidTagsRule) Enabled() bool {
	return true
}

// Severity returns the rule severity
func (r *AwsKinesisanalyticsv2ApplicationInvalidTagsRule) Severity() tflint.Severity {
	return tflint.ERROR
}

// Link returns the rule reference link
func (r *AwsKinesisanalyticsv2ApplicationInvalidTagsRule) Link() string {
	return ""
}
