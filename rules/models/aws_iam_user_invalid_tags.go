...
// AwsIAMUserInvalidTagsRule validates map keys and values
type AwsIAMUserInvalidTagsRule struct {
	tflint.DefaultRule
...
// NewAwsIAMUserInvalidTagsRule returns new rule with default attributes
func NewAwsIAMUserInvalidTagsRule() *AwsIAMUserInvalidTagsRule {
	return &AwsIAMUserInvalidTagsRule{
...
func (r *AwsIAMUserInvalidTagsRule) Name() string {
	return "aws_iam_user_invalid_tags"
}

// Enabled returns whether the rule is enabled by default
func (r *AwsIAMUserInvalidTagsRule) Enabled() bool {
	return true
}

// Severity returns the rule severity
func (r *AwsIAMUserInvalidTagsRule) Severity() tflint.Severity {
	return tflint.ERROR
}

// Link returns the rule reference link
func (r *AwsIAMUserInvalidTagsRule) Link() string {
	return ""
}

// Check validates map keys and values
func (r *AwsIAMUserInvalidTagsRule) Check(runner tflint.Runner) error {
