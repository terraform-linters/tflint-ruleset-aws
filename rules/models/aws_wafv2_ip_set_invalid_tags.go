...
// AwsWafv2IPSetInvalidTagsRule validates map keys and values
type AwsWafv2IPSetInvalidTagsRule struct {
	tflint.DefaultRule
...
// NewAwsWafv2IPSetInvalidTagsRule returns new rule with default attributes
func NewAwsWafv2IPSetInvalidTagsRule() *AwsWafv2IPSetInvalidTagsRule {
	return &AwsWafv2IPSetInvalidTagsRule{
...
func (r *AwsWafv2IPSetInvalidTagsRule) Name() string {
	return "aws_wafv2_ip_set_invalid_tags"
}

// Enabled returns whether the rule is enabled by default
func (r *AwsWafv2IPSetInvalidTagsRule) Enabled() bool {
	return true
}

// Severity returns the rule severity
func (r *AwsWafv2IPSetInvalidTagsRule) Severity() tflint.Severity {
	return tflint.ERROR
}

// Link returns the rule reference link
func (r *AwsWafv2IPSetInvalidTagsRule) Link() string {
	return ""
}

// Check validates map keys and values
func (r *AwsWafv2IPSetInvalidTagsRule) Check(runner tflint.Runner) error {
