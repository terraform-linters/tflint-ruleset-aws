...
func NewAwsServicecatalogProvisionedProductInvalidProductIDRule() *AwsServicecatalogProvisionedProductInvalidProductIDRule {
	return &AwsServicecatalogProvisionedProductInvalidProductIDRule{
...
func (r *AwsServicecatalogProvisionedProductInvalidProductIDRule) Name() string {
	return "aws_servicecatalog_provisioned_product_invalid_product_id"
}
...
func (r *AwsServicecatalogProvisionedProductInvalidProductIDRule) Severity() string {
	return tflint.ERROR
}
