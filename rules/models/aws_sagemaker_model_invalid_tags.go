...
// AwsSagemakerModelInvalidTagsRule validates map keys and values
type AwsSagemakerModelInvalidTagsRule struct {
	tflint.DefaultRule
...
// NewAwsSagemakerModelInvalidTagsRule returns new rule with default attributes
func NewAwsSagemakerModelInvalidTagsRule() *AwsSagemakerModelInvalidTagsRule {
	return &AwsSagemakerModelInvalidTagsRule{
...
func (r *AwsSagemakerModelInvalidTagsRule) Name() string {
	return "aws_sagemaker_model_invalid_tags"
}

// Enabled returns whether the rule is enabled by default
func (r *AwsSagemakerModelInvalidTagsRule) Enabled() bool {
	return true
}

// Severity returns the rule severity
func (r *AwsSagemakerModelInvalidTagsRule) Severity() tflint.Severity {
	return tflint.ERROR
}

// Link returns the rule reference link
func (r *AwsSagemakerModelInvalidTagsRule) Link() string {
	return ""
}

// Check validates map keys and values
func (r *AwsSagemakerModelInvalidTagsRule) Check(runner tflint.Runner) error {
