...
// AwsSagemakerDomainInvalidTagsRule validates map keys and values
type AwsSagemakerDomainInvalidTagsRule struct {
	tflint.DefaultRule
...
// NewAwsSagemakerDomainInvalidTagsRule returns new rule with default attributes
func NewAwsSagemakerDomainInvalidTagsRule() *AwsSagemakerDomainInvalidTagsRule {
	return &AwsSagemakerDomainInvalidTagsRule{
...
func (r *AwsSagemakerDomainInvalidTagsRule) Name() string {
	return "aws_sagemaker_domain_invalid_tags"
}

// Enabled returns whether the rule is enabled by default
func (r *AwsSagemakerDomainInvalidTagsRule) Enabled() bool {
	return true
}

// Severity returns the rule severity
func (r *AwsSagemakerDomainInvalidTagsRule) Severity() tflint.Severity {
	return tflint.ERROR
}

// Link returns the rule reference link
func (r *AwsSagemakerDomainInvalidTagsRule) Link() string {
	return ""
}

// Check validates map keys and values
func (r *AwsSagemakerDomainInvalidTagsRule) Check(runner tflint.Runner) error {
