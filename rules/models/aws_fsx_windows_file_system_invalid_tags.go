...
// AwsFsxWindowsFileSystemInvalidTagsRule validates map keys and values
type AwsFsxWindowsFileSystemInvalidTagsRule struct {
	tflint.DefaultRule
...
// NewAwsFsxWindowsFileSystemInvalidTagsRule returns new rule with default attributes
func NewAwsFsxWindowsFileSystemInvalidTagsRule() *AwsFsxWindowsFileSystemInvalidTagsRule {
	return &AwsFsxWindowsFileSystemInvalidTagsRule{
...
func (r *AwsFsxWindowsFileSystemInvalidTagsRule) Name() string {
	return "aws_fsx_windows_file_system_invalid_tags"
}

// Enabled returns whether the rule is enabled by default
func (r *AwsFsxWindowsFileSystemInvalidTagsRule) Enabled() bool {
	return true
}

// Severity returns the rule severity
func (r *AwsFsxWindowsFileSystemInvalidTagsRule) Severity() tflint.Severity {
	return tflint.ERROR
}

// Link returns the rule reference link
func (r *AwsFsxWindowsFileSystemInvalidTagsRule) Link() string {
	return ""
}

// Check validates map keys and values
func (r *AwsFsxWindowsFileSystemInvalidTagsRule) Check(runner tflint.Runner) error {
