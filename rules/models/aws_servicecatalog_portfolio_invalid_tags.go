...
// AwsServicecatalogPortfolioInvalidTagsRule validates map keys and values
type AwsServicecatalogPortfolioInvalidTagsRule struct {
	tflint.DefaultRule
...
// NewAwsServicecatalogPortfolioInvalidTagsRule returns new rule with default attributes
func NewAwsServicecatalogPortfolioInvalidTagsRule() *AwsServicecatalogPortfolioInvalidTagsRule {
...
func (r *AwsServicecatalogPortfolioInvalidTagsRule) Name() string {
	return "aws_servicecatalog_portfolio_invalid_tags"
}

// Enabled returns whether the rule is enabled by default
func (r *AwsServicecatalogPortfolioInvalidTagsRule) Enabled() bool {
	return true
}

// Severity returns the rule severity
func (r *AwsServicecatalogPortfolioInvalidTagsRule) Severity() tflint.Severity {
	return tflint.ERROR
}

// Link returns the rule reference link
func (r *AwsServicecatalogPortfolioInvalidTagsRule) Link() string {
	return ""
}

// Check validates map keys and values
func (r *AwsServicecatalogPortfolioInvalidTagsRule) Check(runner tflint.Runner) error {
