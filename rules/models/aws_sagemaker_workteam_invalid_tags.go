...
// AwsSagemakerWorkteamInvalidTagsRule validates map keys and values
type AwsSagemakerWorkteamInvalidTagsRule struct {
	tflint.DefaultRule
...
// NewAwsSagemakerWorkteamInvalidTagsRule returns new rule with default attributes
func NewAwsSagemakerWorkteamInvalidTagsRule() *AwsSagemakerWorkteamInvalidTagsRule {
	return &AwsSagemakerWorkteamInvalidTagsRule{
...
func (r *AwsSagemakerWorkteamInvalidTagsRule) Name() string {
	return "aws_sagemaker_workteam_invalid_tags"
}

// Enabled returns whether the rule is enabled by default
func (r *AwsSagemakerWorkteamInvalidTagsRule) Enabled() bool {
	return true
}

// Severity returns the rule severity
func (r *AwsSagemakerWorkteamInvalidTagsRule) Severity() tflint.Severity {
	return tflint.ERROR
}

// Link returns the rule reference link
func (r *AwsSagemakerWorkteamInvalidTagsRule) Link() string {
	return ""
}

// Check validates map keys and values
func (r *AwsSagemakerWorkteamInvalidTagsRule) Check(runner tflint.Runner) error {
