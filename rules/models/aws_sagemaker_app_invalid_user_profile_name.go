...
func NewAwsSagemakerAppInvalidUserProfileNameRule() *AwsSagemakerAppInvalidUserProfileNameRule {
	return &AwsSagemakerAppInvalidUserProfileNameRule{
...
func (r *AwsSagemakerAppInvalidUserProfileNameRule) Name() string {
	return "aws_sagemaker_app_invalid_user_profile_name"
}
...
func (r *AwsSagemakerAppInvalidUserProfileNameRule) Severity() string {
	return tflint.ERROR
}
