...
// AwsSsmActivationInvalidTagsRule validates map keys and values
type AwsSsmActivationInvalidTagsRule struct {
	tflint.DefaultRule
...
// NewAwsSsmActivationInvalidTagsRule returns new rule with default attributes
func NewAwsSsmActivationInvalidTagsRule() *AwsSsmActivationInvalidTagsRule {
	return &AwsSsmActivationInvalidTagsRule{
...
func (r *AwsSsmActivationInvalidTagsRule) Name() string {
	return "aws_ssm_activation_invalid_tags"
}

// Enabled returns whether the rule is enabled by default
func (r *AwsSsmActivationInvalidTagsRule) Enabled() bool {
	return true
}

// Severity returns the rule severity
func (r *AwsSsmActivationInvalidTagsRule) Severity() tflint.Severity {
	return tflint.ERROR
}

// Link returns the rule reference link
func (r *AwsSsmActivationInvalidTagsRule) Link() string {
	return ""
}

// Check validates map keys and values
func (r *AwsSsmActivationInvalidTagsRule) Check(runner tflint.Runner) error {
