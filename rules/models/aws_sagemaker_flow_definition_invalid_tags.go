...
// AwsSagemakerFlowDefinitionInvalidTagsRule validates map keys and values
type AwsSagemakerFlowDefinitionInvalidTagsRule struct {
	tflint.DefaultRule
...
// NewAwsSagemakerFlowDefinitionInvalidTagsRule returns new rule with default attributes
func NewAwsSagemakerFlowDefinitionInvalidTagsRule() *AwsSagemakerFlowDefinitionInvalidTagsRule {
	return &AwsSagemakerFlowDefinitionInvalidTagsRule{
...
func (r *AwsSagemakerFlowDefinitionInvalidTagsRule) Name() string {
	return "aws_sagemaker_flow_definition_invalid_tags"
}

// Enabled returns whether the rule is enabled by default
func (r *AwsSagemakerFlowDefinitionInvalidTagsRule) Enabled() bool {
	return true
}

// Severity returns the rule severity
func (r *AwsSagemakerFlowDefinitionInvalidTagsRule) Severity() tflint.Severity {
	return tflint.ERROR
}

// Link returns the rule reference link
func (r *AwsSagemakerFlowDefinitionInvalidTagsRule) Link() string {
	return ""
}

// Check validates map keys and values
func (r *AwsSagemakerFlowDefinitionInvalidTagsRule) Check(runner tflint.Runner) error {
