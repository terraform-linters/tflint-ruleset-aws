...
// AwsSagemakerDeviceFleetInvalidTagsRule validates map keys and values
type AwsSagemakerDeviceFleetInvalidTagsRule struct {
	tflint.DefaultRule
...
// NewAwsSagemakerDeviceFleetInvalidTagsRule returns new rule with default attributes
func NewAwsSagemakerDeviceFleetInvalidTagsRule() *AwsSagemakerDeviceFleetInvalidTagsRule {
	return &AwsSagemakerDeviceFleetInvalidTagsRule{
...
func (r *AwsSagemakerDeviceFleetInvalidTagsRule) Name() string {
	return "aws_sagemaker_device_fleet_invalid_tags"
}

// Enabled returns whether the rule is enabled by default
func (r *AwsSagemakerDeviceFleetInvalidTagsRule) Enabled() bool {
	return true
}

// Severity returns the rule severity
func (r *AwsSagemakerDeviceFleetInvalidTagsRule) Severity() tflint.Severity {
	return tflint.ERROR
}

// Link returns the rule reference link
func (r *AwsSagemakerDeviceFleetInvalidTagsRule) Link() string {
	return ""
}

// Check validates map keys and values
func (r *AwsSagemakerDeviceFleetInvalidTagsRule) Check(runner tflint.Runner) error {
