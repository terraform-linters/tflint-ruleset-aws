...
// AwsSsmParameterInvalidTagsRule validates map keys and values
type AwsSsmParameterInvalidTagsRule struct {
	tflint.DefaultRule
...
// NewAwsSsmParameterInvalidTagsRule returns new rule with default attributes
func NewAwsSsmParameterInvalidTagsRule() *AwsSsmParameterInvalidTagsRule {
...
func (r *AwsSsmParameterInvalidTagsRule) Name() string {
	return "aws_ssm_parameter_invalid_tags"
}

// Enabled returns whether the rule is enabled by default
func (r *AwsSsmParameterInvalidTagsRule) Enabled() bool {
	return true
}

// Severity returns the rule severity
func (r *AwsSsmParameterInvalidTagsRule) Severity() tflint.Severity {
	return tflint.ERROR
}

// Link returns the rule reference link
func (r *AwsSsmParameterInvalidTagsRule) Link() string {
	return ""
}

// Check validates map keys and values
func (r *AwsSsmParameterInvalidTagsRule) Check(runner tflint.Runner) error {
