...
// AwsSsmDocumentInvalidTagsRule validates map keys and values
type AwsSsmDocumentInvalidTagsRule struct {
	tflint.DefaultRule
...
// NewAwsSsmDocumentInvalidTagsRule returns new rule with default attributes
func NewAwsSsmDocumentInvalidTagsRule() *AwsSsmDocumentInvalidTagsRule {
	return &AwsSsmDocumentInvalidTagsRule{
...
func (r *AwsSsmDocumentInvalidTagsRule) Name() string {
	return "aws_ssm_document_invalid_tags"
}

// Enabled returns whether the rule is enabled by default
func (r *AwsSsmDocumentInvalidTagsRule) Enabled() bool {
	return true
}

// Severity returns the rule severity
func (r *AwsSsmDocumentInvalidTagsRule) Severity() tflint.Severity {
	return tflint.ERROR
}

// Link returns the rule reference link
func (r *AwsSsmDocumentInvalidTagsRule) Link() string {
	return ""
}

// Check validates map keys and values
func (r *AwsSsmDocumentInvalidTagsRule) Check(runner tflint.Runner) error {
