...
// AwsWafv2WebACLInvalidTagsRule validates map keys and values
type AwsWafv2WebACLInvalidTagsRule struct {
	tflint.DefaultRule
...
// NewAwsWafv2WebACLInvalidTagsRule returns new rule with default attributes
func NewAwsWafv2WebACLInvalidTagsRule() *AwsWafv2WebACLInvalidTagsRule {
	return &AwsWafv2WebACLInvalidTagsRule{
...
func (r *AwsWafv2WebACLInvalidTagsRule) Name() string {
	return "aws_wafv2_web_acl_invalid_tags"
}

// Enabled returns whether the rule is enabled by default
func (r *AwsWafv2WebACLInvalidTagsRule) Enabled() bool {
	return true
}

// Severity returns the rule severity
func (r *AwsWafv2WebACLInvalidTagsRule) Severity() tflint.Severity {
	return tflint.ERROR
}

// Link returns the rule reference link
func (r *AwsWafv2WebACLInvalidTagsRule) Link() string {
	return ""
}

// Check validates map keys and values
func (r *AwsWafv2WebACLInvalidTagsRule) Check(runner tflint.Runner) error {
