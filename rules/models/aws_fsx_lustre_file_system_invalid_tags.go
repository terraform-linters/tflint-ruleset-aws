...
// AwsFsxLustreFileSystemInvalidTagsRule validates map keys and values
type AwsFsxLustreFileSystemInvalidTagsRule struct {
	tflint.DefaultRule
...
// NewAwsFsxLustreFileSystemInvalidTagsRule returns new rule with default attributes
func NewAwsFsxLustreFileSystemInvalidTagsRule() *AwsFsxLustreFileSystemInvalidTagsRule {
	return &AwsFsxLustreFileSystemInvalidTagsRule{
...
func (r *AwsFsxLustreFileSystemInvalidTagsRule) Name() string {
	return "aws_fsx_lustre_file_system_invalid_tags"
}

// Enabled returns whether the rule is enabled by default
func (r *AwsFsxLustreFileSystemInvalidTagsRule) Enabled() bool {
	return true
}

// Severity returns the rule severity
func (r *AwsFsxLustreFileSystemInvalidTagsRule) Severity() tflint.Severity {
	return tflint.ERROR
}

// Link returns the rule reference link
func (r *AwsFsxLustreFileSystemInvalidTagsRule) Link() string {
	return ""
}

// Check validates map keys and values
func (r *AwsFsxLustreFileSystemInvalidTagsRule) Check(runner tflint.Runner) error {
