...
// NewAwsTimestreamwriteTableInvalidTagsRule returns new rule with default attributes
func NewAwsTimestreamwriteTableInvalidTagsRule() *AwsTimestreamwriteTableInvalidTagsRule {
	return &AwsTimestreamwriteTableInvalidTagsRule{
...
func (r *AwsTimestreamwriteTableInvalidTagsRule) Name() string {
	return "aws_timestreamwrite_table_invalid_tags"
}

// Enabled returns whether the rule is enabled by default
func (r *AwsTimestreamwriteTableInvalidTagsRule) Enabled() bool {
	return true
}

// Severity returns the rule severity
func (r *AwsTimestreamwriteTableInvalidTagsRule) Severity() tflint.Severity {
	return tflint.ERROR
}

// Link returns the rule reference link
func (r *AwsTimestreamwriteTableInvalidTagsRule) Link() string {
	return ""
}
