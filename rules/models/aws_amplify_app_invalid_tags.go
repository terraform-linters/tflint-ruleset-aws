...
// AwsAmplifyAppInvalidTagsRule validates map keys and values
type AwsAmplifyAppInvalidTagsRule struct {
	tflint.DefaultRule
...
// NewAwsAmplifyAppInvalidTagsRule returns new rule with default attributes
func NewAwsAmplifyAppInvalidTagsRule() *AwsAmplifyAppInvalidTagsRule {
	return &AwsAmplifyAppInvalidTagsRule{
...
func (r *AwsAmplifyAppInvalidTagsRule) Name() string {
	return "aws_amplify_app_invalid_tags"
}

// Enabled returns whether the rule is enabled by default
func (r *AwsAmplifyAppInvalidTagsRule) Enabled() bool {
	return true
}

// Severity returns the rule severity
func (r *AwsAmplifyAppInvalidTagsRule) Severity() tflint.Severity {
	return tflint.ERROR
}

// Link returns the rule reference link
func (r *AwsAmplifyAppInvalidTagsRule) Link() string {
	return ""
}

// Check validates map keys and values
func (r *AwsAmplifyAppInvalidTagsRule) Check(runner tflint.Runner) error {
