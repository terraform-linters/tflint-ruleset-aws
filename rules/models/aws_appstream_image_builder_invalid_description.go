...
func NewAwsAppstreamImageBuilderInvalidDescriptionRule() *AwsAppstreamImageBuilderInvalidDescriptionRule {
	return &AwsAppstreamImageBuilderInvalidDescriptionRule{
...
func (r *AwsAppstreamImageBuilderInvalidDescriptionRule) Name() string {
	return "aws_appstream_image_builder_invalid_description"
}
...
func (r *AwsAppstreamImageBuilderInvalidDescriptionRule) Severity() string {
	return tflint.ERROR
}
