...
// AwsEcsTaskSetInvalidTagsRule validates map keys and values
type AwsEcsTaskSetInvalidTagsRule struct {
	tflint.DefaultRule
...
// NewAwsEcsTaskSetInvalidTagsRule returns new rule with default attributes
func NewAwsEcsTaskSetInvalidTagsRule() *AwsEcsTaskSetInvalidTagsRule {
	return &AwsEcsTaskSetInvalidTagsRule{
...
func (r *AwsEcsTaskSetInvalidTagsRule) Name() string {
	return "aws_ecs_task_set_invalid_tags"
}

// Enabled returns whether the rule is enabled by default
func (r *AwsEcsTaskSetInvalidTagsRule) Enabled() bool {
	return true
}

// Severity returns the rule severity
func (r *AwsEcsTaskSetInvalidTagsRule) Severity() tflint.Severity {
	return tflint.ERROR
}

// Link returns the rule reference link
func (r *AwsEcsTaskSetInvalidTagsRule) Link() string {
	return ""
}

// Check validates map keys and values
func (r *AwsEcsTaskSetInvalidTagsRule) Check(runner tflint.Runner) error {
