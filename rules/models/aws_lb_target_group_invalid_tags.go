...
// AwsLbTargetGroupInvalidTagsRule validates map keys and values
type AwsLbTargetGroupInvalidTagsRule struct {
	tflint.DefaultRule
...
// NewAwsLbTargetGroupInvalidTagsRule returns new rule with default attributes
func NewAwsLbTargetGroupInvalidTagsRule() *AwsLbTargetGroupInvalidTagsRule {
	return &AwsLbTargetGroupInvalidTagsRule{
...
func (r *AwsLbTargetGroupInvalidTagsRule) Name() string {
	return "aws_lb_target_group_invalid_tags"
}

// Enabled returns whether the rule is enabled by default
func (r *AwsLbTargetGroupInvalidTagsRule) Enabled() bool {
	return true
}

// Severity returns the rule severity
func (r *AwsLbTargetGroupInvalidTagsRule) Severity() tflint.Severity {
	return tflint.ERROR
}

// Link returns the rule reference link
func (r *AwsLbTargetGroupInvalidTagsRule) Link() string {
	return ""
}

// Check validates map keys and values
func (r *AwsLbTargetGroupInvalidTagsRule) Check(runner tflint.Runner) error {
