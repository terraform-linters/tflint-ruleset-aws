...
func (r *AwsApigatewayv2IntegrationResponseInvalidContentHandlingStrategyRule) Name() string {
	return "aws_apigatewayv2_integration_response_invalid_content_handling_strategy"
}
...
func (r *AwsApigatewayv2IntegrationResponseInvalidContentHandlingStrategyRule) Severity() string {
	return tflint.ERROR
}
