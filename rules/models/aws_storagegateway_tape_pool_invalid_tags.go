...
// NewAwsStoragegatewayTapePoolInvalidTagsRule returns new rule with default attributes
func NewAwsStoragegatewayTapePoolInvalidTagsRule() *AwsStoragegatewayTapePoolInvalidTagsRule {
	return &AwsStoragegatewayTapePoolInvalidTagsRule{
...
func (r *AwsStoragegatewayTapePoolInvalidTagsRule) Name() string {
	return "aws_storagegateway_tape_pool_invalid_tags"
}

// Enabled returns whether the rule is enabled by default
func (r *AwsStoragegatewayTapePoolInvalidTagsRule) Enabled() bool {
	return true
}

// Severity returns the rule severity
func (r *AwsStoragegatewayTapePoolInvalidTagsRule) Severity() tflint.Severity {
	return tflint.ERROR
}

// Link returns the rule reference link
func (r *AwsStoragegatewayTapePoolInvalidTagsRule) Link() string {
	return ""
}
