...
func (r *AwsCodeartifactRepositoryPermissionsPolicyInvalidPolicyDocumentRule) Name() string {
	return "aws_codeartifact_repository_permissions_policy_invalid_policy_document"
}
...
func (r *AwsCodeartifactRepositoryPermissionsPolicyInvalidPolicyDocumentRule) Severity() string {
	return tflint.ERROR
}
