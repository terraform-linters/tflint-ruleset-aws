...
// NewAwsSagemakerFeatureGroupInvalidTagsRule returns new rule with default attributes
func NewAwsSagemakerFeatureGroupInvalidTagsRule() *AwsSagemakerFeatureGroupInvalidTagsRule {
	return &AwsSagemakerFeatureGroupInvalidTagsRule{
...
func (r *AwsSagemakerFeatureGroupInvalidTagsRule) Name() string {
	return "aws_sagemaker_feature_group_invalid_tags"
}

// Enabled returns whether the rule is enabled by default
func (r *AwsSagemakerFeatureGroupInvalidTagsRule) Enabled() bool {
	return true
}

// Severity returns the rule severity
func (r *AwsSagemakerFeatureGroupInvalidTagsRule) Severity() tflint.Severity {
	return tflint.ERROR
}

// Link returns the rule reference link
func (r *AwsSagemakerFeatureGroupInvalidTagsRule) Link() string {
	return ""
}
