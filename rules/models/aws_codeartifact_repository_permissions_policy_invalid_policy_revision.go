...
func NewAwsCodeartifactRepositoryPermissionsPolicyInvalidPolicyRevisionRule() *AwsCodeartifactRepositoryPermissionsPolicyInvalidPolicyRevisionRule {
	return &AwsCodeartifactRepositoryPermissionsPolicyInvalidPolicyRevisionRule{
...
func (r *AwsCodeartifactRepositoryPermissionsPolicyInvalidPolicyRevisionRule) Name() string {
	return "aws_codeartifact_repository_permissions_policy_invalid_policy_revision"
}
...
func (r *AwsCodeartifactRepositoryPermissionsPolicyInvalidPolicyRevisionRule) Severity() string {
	return tflint.ERROR
}
