...
// AwsIAMRoleInvalidTagsRule validates map keys and values
type AwsIAMRoleInvalidTagsRule struct {
	tflint.DefaultRule
...
// NewAwsIAMRoleInvalidTagsRule returns new rule with default attributes
func NewAwsIAMRoleInvalidTagsRule() *AwsIAMRoleInvalidTagsRule {
	return &AwsIAMRoleInvalidTagsRule{
...
func (r *AwsIAMRoleInvalidTagsRule) Name() string {
	return "aws_iam_role_invalid_tags"
}

// Enabled returns whether the rule is enabled by default
func (r *AwsIAMRoleInvalidTagsRule) Enabled() bool {
	return true
}

// Severity returns the rule severity
func (r *AwsIAMRoleInvalidTagsRule) Severity() tflint.Severity {
	return tflint.ERROR
}

// Link returns the rule reference link
func (r *AwsIAMRoleInvalidTagsRule) Link() string {
	return ""
}

// Check validates map keys and values
func (r *AwsIAMRoleInvalidTagsRule) Check(runner tflint.Runner) error {
