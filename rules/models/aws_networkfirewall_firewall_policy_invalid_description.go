...
func NewAwsNetworkfirewallFirewallPolicyInvalidDescriptionRule() *AwsNetworkfirewallFirewallPolicyInvalidDescriptionRule {
	return &AwsNetworkfirewallFirewallPolicyInvalidDescriptionRule{
...
func (r *AwsNetworkfirewallFirewallPolicyInvalidDescriptionRule) Name() string {
	return "aws_networkfirewall_firewall_policy_invalid_description"
}
...
func (r *AwsNetworkfirewallFirewallPolicyInvalidDescriptionRule) Severity() string {
	return tflint.ERROR
}
