...
// AwsSagemakerNotebookInstanceInvalidTagsRule validates map keys and values
type AwsSagemakerNotebookInstanceInvalidTagsRule struct {
	tflint.DefaultRule
...
// NewAwsSagemakerNotebookInstanceInvalidTagsRule returns new rule with default attributes
func NewAwsSagemakerNotebookInstanceInvalidTagsRule() *AwsSagemakerNotebookInstanceInvalidTagsRule {
	return &AwsSagemakerNotebookInstanceInvalidTagsRule{
...
func (r *AwsSagemakerNotebookInstanceInvalidTagsRule) Name() string {
	return "aws_sagemaker_notebook_instance_invalid_tags"
}

// Enabled returns whether the rule is enabled by default
func (r *AwsSagemakerNotebookInstanceInvalidTagsRule) Enabled() bool {
	return true
}

// Severity returns the rule severity
func (r *AwsSagemakerNotebookInstanceInvalidTagsRule) Severity() tflint.Severity {
	return tflint.ERROR
}

// Link returns the rule reference link
func (r *AwsSagemakerNotebookInstanceInvalidTagsRule) Link() string {
	return ""
}

// Check validates map keys and values
func (r *AwsSagemakerNotebookInstanceInvalidTagsRule) Check(runner tflint.Runner) error {
