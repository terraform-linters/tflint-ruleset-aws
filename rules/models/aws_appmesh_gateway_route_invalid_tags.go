...
// NewAwsAppmeshGatewayRouteInvalidTagsRule returns new rule with default attributes
func NewAwsAppmeshGatewayRouteInvalidTagsRule() *AwsAppmeshGatewayRouteInvalidTagsRule {
...
func (r *AwsAppmeshGatewayRouteInvalidTagsRule) Name() string {
	return "aws_appmesh_gateway_route_invalid_tags"
}

// Enabled returns whether the rule is enabled by default
func (r *AwsAppmeshGatewayRouteInvalidTagsRule) Enabled() bool {
	return true
}

// Severity returns the rule severity
func (r *AwsAppmeshGatewayRouteInvalidTagsRule) Severity() tflint.Severity {
	return tflint.ERROR
}

// Link returns the rule reference link
func (r *AwsAppmeshGatewayRouteInvalidTagsRule) Link() string {
	return ""
}
