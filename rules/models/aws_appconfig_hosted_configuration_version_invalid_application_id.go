...
func (r *AwsAppconfigHostedConfigurationVersionInvalidApplicationIDRule) Name() string {
	return "aws_appconfig_hosted_configuration_version_invalid_application_id"
}
...
func (r *AwsAppconfigHostedConfigurationVersionInvalidApplicationIDRule) Severity() string {
	return tflint.ERROR
}
