...
// NewAwsFsxOpenzfsSnapshotInvalidTagsRule returns new rule with default attributes
func NewAwsFsxOpenzfsSnapshotInvalidTagsRule() *AwsFsxOpenzfsSnapshotInvalidTagsRule {
	return &AwsFsxOpenzfsSnapshotInvalidTagsRule{
...
func (r *AwsFsxOpenzfsSnapshotInvalidTagsRule) Name() string {
	return "aws_fsx_openzfs_snapshot_invalid_tags"
}

// Enabled returns whether the rule is enabled by default
func (r *AwsFsxOpenzfsSnapshotInvalidTagsRule) Enabled() bool {
	return true
}

// Severity returns the rule severity
func (r *AwsFsxOpenzfsSnapshotInvalidTagsRule) Severity() tflint.Severity {
	return tflint.ERROR
}

// Link returns the rule reference link
func (r *AwsFsxOpenzfsSnapshotInvalidTagsRule) Link() string {
	return ""
}
