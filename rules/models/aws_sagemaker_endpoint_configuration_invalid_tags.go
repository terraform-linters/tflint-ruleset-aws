...
// NewAwsSagemakerEndpointConfigurationInvalidTagsRule returns new rule with default attributes
func NewAwsSagemakerEndpointConfigurationInvalidTagsRule() *AwsSagemakerEndpointConfigurationInvalidTagsRule {
	return &AwsSagemakerEndpointConfigurationInvalidTagsRule{
...
func (r *AwsSagemakerEndpointConfigurationInvalidTagsRule) Name() string {
	return "aws_sagemaker_endpoint_configuration_invalid_tags"
}

// Enabled returns whether the rule is enabled by default
func (r *AwsSagemakerEndpointConfigurationInvalidTagsRule) Enabled() bool {
	return true
}

// Severity returns the rule severity
func (r *AwsSagemakerEndpointConfigurationInvalidTagsRule) Severity() tflint.Severity {
	return tflint.ERROR
}

// Link returns the rule reference link
func (r *AwsSagemakerEndpointConfigurationInvalidTagsRule) Link() string {
	return ""
}
