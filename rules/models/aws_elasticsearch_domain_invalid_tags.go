...
// NewAwsElasticsearchDomainInvalidTagsRule returns new rule with default attributes
func NewAwsElasticsearchDomainInvalidTagsRule() *AwsElasticsearchDomainInvalidTagsRule {
	return &AwsElasticsearchDomainInvalidTagsRule{
...
func (r *AwsElasticsearchDomainInvalidTagsRule) Name() string {
	return "aws_elasticsearch_domain_invalid_tags"
}

// Enabled returns whether the rule is enabled by default
func (r *AwsElasticsearchDomainInvalidTagsRule) Enabled() bool {
	return true
}

// Severity returns the rule severity
func (r *AwsElasticsearchDomainInvalidTagsRule) Severity() tflint.Severity {
	return tflint.ERROR
}

// Link returns the rule reference link
func (r *AwsElasticsearchDomainInvalidTagsRule) Link() string {
	return ""
}
