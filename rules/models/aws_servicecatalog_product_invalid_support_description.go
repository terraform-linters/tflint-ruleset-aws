...
func NewAwsServicecatalogProductInvalidSupportDescriptionRule() *AwsServicecatalogProductInvalidSupportDescriptionRule {
	return &AwsServicecatalogProductInvalidSupportDescriptionRule{
		resourceType:  "aws_servicecatalog_product",
		attributeName: "support_description",
		max:           8191,
	}
}
...
func (r *AwsServicecatalogProductInvalidSupportDescriptionRule) Name() string {
	return "aws_servicecatalog_product_invalid_support_description"
}
...
func (r *AwsServicecatalogProductInvalidSupportDescriptionRule) Severity() string {
	return tflint.ERROR
}
		...
		return runner.EnsureNoError(err, func() error {
			if len(val) > r.max {
				runner.EmitIssueOnExpr(
					r,
					"support_description must be 8191 characters or less",
					attribute.Expr,
				)
			}
			return nil
