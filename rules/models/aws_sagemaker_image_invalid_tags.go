...
// AwsSagemakerImageInvalidTagsRule validates map keys and values
type AwsSagemakerImageInvalidTagsRule struct {
	tflint.DefaultRule
...
// NewAwsSagemakerImageInvalidTagsRule returns new rule with default attributes
func NewAwsSagemakerImageInvalidTagsRule() *AwsSagemakerImageInvalidTagsRule {
	return &AwsSagemakerImageInvalidTagsRule{
...
func (r *AwsSagemakerImageInvalidTagsRule) Name() string {
	return "aws_sagemaker_image_invalid_tags"
}

// Enabled returns whether the rule is enabled by default
func (r *AwsSagemakerImageInvalidTagsRule) Enabled() bool {
	return true
}

// Severity returns the rule severity
func (r *AwsSagemakerImageInvalidTagsRule) Severity() tflint.Severity {
	return tflint.ERROR
}

// Link returns the rule reference link
func (r *AwsSagemakerImageInvalidTagsRule) Link() string {
	return ""
}

// Check validates map keys and values
func (r *AwsSagemakerImageInvalidTagsRule) Check(runner tflint.Runner) error {
