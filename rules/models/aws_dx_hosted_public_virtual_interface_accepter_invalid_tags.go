...
// NewAwsDxHostedPublicVirtualInterfaceAccepterInvalidTagsRule returns new rule with default attributes
func NewAwsDxHostedPublicVirtualInterfaceAccepterInvalidTagsRule() *AwsDxHostedPublicVirtualInterfaceAccepterInvalidTagsRule {
	return &AwsDxHostedPublicVirtualInterfaceAccepterInvalidTagsRule{
...
func (r *AwsDxHostedPublicVirtualInterfaceAccepterInvalidTagsRule) Name() string {
	return "aws_dx_hosted_public_virtual_interface_accepter_invalid_tags"
}

// Enabled returns whether the rule is enabled by default
func (r *AwsDxHostedPublicVirtualInterfaceAccepterInvalidTagsRule) Enabled() bool {
	return true
}

// Severity returns the rule severity
func (r *AwsDxHostedPublicVirtualInterfaceAccepterInvalidTagsRule) Severity() tflint.Severity {
	return tflint.ERROR
}

// Link returns the rule reference link
func (r *AwsDxHostedPublicVirtualInterfaceAccepterInvalidTagsRule) Link() string {
	return ""
}
