...
func NewAwsAppconfigDeploymentStrategyInvalidDescriptionRule() *AwsAppconfigDeploymentStrategyInvalidDescriptionRule {
	return &AwsAppconfigDeploymentStrategyInvalidDescriptionRule{
...
func (r *AwsAppconfigDeploymentStrategyInvalidDescriptionRule) Name() string {
	return "aws_appconfig_deployment_strategy_invalid_description"
}
...
func (r *AwsAppconfigDeploymentStrategyInvalidDescriptionRule) Severity() string {
	return tflint.ERROR
}
