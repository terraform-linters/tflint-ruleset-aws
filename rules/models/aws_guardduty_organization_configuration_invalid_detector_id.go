...
func NewAwsGuarddutyOrganizationConfigurationInvalidDetectorIDRule() *AwsGuarddutyOrganizationConfigurationInvalidDetectorIDRule {
	return &AwsGuarddutyOrganizationConfigurationInvalidDetectorIDRule{
...
func (r *AwsGuarddutyOrganizationConfigurationInvalidDetectorIDRule) Name() string {
	return "aws_guardduty_organization_configuration_invalid_detector_id"
}
...
func (r *AwsGuarddutyOrganizationConfigurationInvalidDetectorIDRule) Severity() string {
	return tflint.ERROR
}
