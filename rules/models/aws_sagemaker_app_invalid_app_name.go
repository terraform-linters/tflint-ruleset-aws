...
func NewAwsSagemakerAppInvalidAppNameRule() *AwsSagemakerAppInvalidAppNameRule {
	return &AwsSagemakerAppInvalidAppNameRule{
...
func (r *AwsSagemakerAppInvalidAppNameRule) Name() string {
	return "aws_sagemaker_app_invalid_app_name"
}
...
func (r *AwsSagemakerAppInvalidAppNameRule) Severity() string {
	return tflint.ERROR
}
		...
		return runner.EnsureNoError(err, func() error {
			if len(val) > r.max {
				runner.EmitIssueOnExpr(
					r,
					"app_name must be 63 characters or less",
					attribute.Expr,
				)
			}
