...
// AwsFsxBackupInvalidTagsRule validates map keys and values
type AwsFsxBackupInvalidTagsRule struct {
	tflint.DefaultRule
...
// NewAwsFsxBackupInvalidTagsRule returns new rule with default attributes
func NewAwsFsxBackupInvalidTagsRule() *AwsFsxBackupInvalidTagsRule {
	return &AwsFsxBackupInvalidTagsRule{
...
func (r *AwsFsxBackupInvalidTagsRule) Name() string {
	return "aws_fsx_backup_invalid_tags"
}

// Enabled returns whether the rule is enabled by default
func (r *AwsFsxBackupInvalidTagsRule) Enabled() bool {
	return true
}

// Severity returns the rule severity
func (r *AwsFsxBackupInvalidTagsRule) Severity() tflint.Severity {
	return tflint.ERROR
}

// Link returns the rule reference link
func (r *AwsFsxBackupInvalidTagsRule) Link() string {
	return ""
}

// Check validates map keys and values
func (r *AwsFsxBackupInvalidTagsRule) Check(runner tflint.Runner) error {
