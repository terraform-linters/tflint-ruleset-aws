...
// NewAwsGuarddutyFilterInvalidTagsRule returns new rule with default attributes
func NewAwsGuarddutyFilterInvalidTagsRule() *AwsGuarddutyFilterInvalidTagsRule {
	return &AwsGuarddutyFilterInvalidTagsRule{
...
func (r *AwsGuarddutyFilterInvalidTagsRule) Name() string {
	return "aws_guardduty_filter_invalid_tags"
}

// Enabled returns whether the rule is enabled by default
func (r *AwsGuarddutyFilterInvalidTagsRule) Enabled() bool {
	return true
}

// Severity returns the rule severity
func (r *AwsGuarddutyFilterInvalidTagsRule) Severity() tflint.Severity {
	return tflint.ERROR
}

// Link returns the rule reference link
func (r *AwsGuarddutyFilterInvalidTagsRule) Link() string {
	return ""
}
