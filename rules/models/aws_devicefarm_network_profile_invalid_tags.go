...
// NewAwsDevicefarmNetworkProfileInvalidTagsRule returns new rule with default attributes
func NewAwsDevicefarmNetworkProfileInvalidTagsRule() *AwsDevicefarmNetworkProfileInvalidTagsRule {
	return &AwsDevicefarmNetworkProfileInvalidTagsRule{
...
func (r *AwsDevicefarmNetworkProfileInvalidTagsRule) Name() string {
	return "aws_devicefarm_network_profile_invalid_tags"
}

// Enabled returns whether the rule is enabled by default
func (r *AwsDevicefarmNetworkProfileInvalidTagsRule) Enabled() bool {
	return true
}

// Severity returns the rule severity
func (r *AwsDevicefarmNetworkProfileInvalidTagsRule) Severity() tflint.Severity {
	return tflint.ERROR
}

// Link returns the rule reference link
func (r *AwsDevicefarmNetworkProfileInvalidTagsRule) Link() string {
	return ""
}
