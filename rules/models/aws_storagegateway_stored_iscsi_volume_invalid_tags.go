...
// NewAwsStoragegatewayStoredIscsiVolumeInvalidTagsRule returns new rule with default attributes
func NewAwsStoragegatewayStoredIscsiVolumeInvalidTagsRule() *AwsStoragegatewayStoredIscsiVolumeInvalidTagsRule {
	return &AwsStoragegatewayStoredIscsiVolumeInvalidTagsRule{
...
func (r *AwsStoragegatewayStoredIscsiVolumeInvalidTagsRule) Name() string {
	return "aws_storagegateway_stored_iscsi_volume_invalid_tags"
}

// Enabled returns whether the rule is enabled by default
func (r *AwsStoragegatewayStoredIscsiVolumeInvalidTagsRule) Enabled() bool {
	return true
}

// Severity returns the rule severity
func (r *AwsStoragegatewayStoredIscsiVolumeInvalidTagsRule) Severity() tflint.Severity {
	return tflint.ERROR
}

// Link returns the rule reference link
func (r *AwsStoragegatewayStoredIscsiVolumeInvalidTagsRule) Link() string {
	return ""
}
