...
func NewAwsStoragegatewayStoredIscsiVolumeInvalidGatewayArnRule() *AwsStoragegatewayStoredIscsiVolumeInvalidGatewayArnRule {
	return &AwsStoragegatewayStoredIscsiVolumeInvalidGatewayArnRule{
...
func (r *AwsStoragegatewayStoredIscsiVolumeInvalidGatewayArnRule) Name() string {
	return "aws_storagegateway_stored_iscsi_volume_invalid_gateway_arn"
}
...
func (r *AwsStoragegatewayStoredIscsiVolumeInvalidGatewayArnRule) Severity() string {
	return tflint.ERROR
}
