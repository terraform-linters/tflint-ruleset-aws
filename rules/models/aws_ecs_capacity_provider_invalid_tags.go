...
// AwsEcsCapacityProviderInvalidTagsRule validates map keys and values
type AwsEcsCapacityProviderInvalidTagsRule struct {
	tflint.DefaultRule
...
// NewAwsEcsCapacityProviderInvalidTagsRule returns new rule with default attributes
func NewAwsEcsCapacityProviderInvalidTagsRule() *AwsEcsCapacityProviderInvalidTagsRule {
	return &AwsEcsCapacityProviderInvalidTagsRule{
...
func (r *AwsEcsCapacityProviderInvalidTagsRule) Name() string {
	return "aws_ecs_capacity_provider_invalid_tags"
}

// Enabled returns whether the rule is enabled by default
func (r *AwsEcsCapacityProviderInvalidTagsRule) Enabled() bool {
	return true
}

// Severity returns the rule severity
func (r *AwsEcsCapacityProviderInvalidTagsRule) Severity() tflint.Severity {
	return tflint.ERROR
}

// Link returns the rule reference link
func (r *AwsEcsCapacityProviderInvalidTagsRule) Link() string {
	return ""
}

// Check validates map keys and values
func (r *AwsEcsCapacityProviderInvalidTagsRule) Check(runner tflint.Runner) error {
