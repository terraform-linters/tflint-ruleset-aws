...
// NewAwsAppstreamImageBuilderInvalidTagsRule returns new rule with default attributes
func NewAwsAppstreamImageBuilderInvalidTagsRule() *AwsAppstreamImageBuilderInvalidTagsRule {
	return &AwsAppstreamImageBuilderInvalidTagsRule{
...
func (r *AwsAppstreamImageBuilderInvalidTagsRule) Name() string {
	return "aws_appstream_image_builder_invalid_tags"
}

// Enabled returns whether the rule is enabled by default
func (r *AwsAppstreamImageBuilderInvalidTagsRule) Enabled() bool {
	return true
}

// Severity returns the rule severity
func (r *AwsAppstreamImageBuilderInvalidTagsRule) Severity() tflint.Severity {
	return tflint.ERROR
}

// Link returns the rule reference link
func (r *AwsAppstreamImageBuilderInvalidTagsRule) Link() string {
	return ""
}
