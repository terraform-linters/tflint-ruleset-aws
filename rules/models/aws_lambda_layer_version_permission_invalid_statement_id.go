...
func NewAwsLambdaLayerVersionPermissionInvalidStatementIDRule() *AwsLambdaLayerVersionPermissionInvalidStatementIDRule {
	return &AwsLambdaLayerVersionPermissionInvalidStatementIDRule{
...
func (r *AwsLambdaLayerVersionPermissionInvalidStatementIDRule) Name() string {
	return "aws_lambda_layer_version_permission_invalid_statement_id"
}
...
func (r *AwsLambdaLayerVersionPermissionInvalidStatementIDRule) Severity() string {
	return tflint.ERROR
}
