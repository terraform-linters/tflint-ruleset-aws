...
func (r *AwsServicecatalogProvisioningArtifactInvalidGuidanceRule) Name() string {
	return "aws_servicecatalog_provisioning_artifact_invalid_guidance"
}
...
func (r *AwsServicecatalogProvisioningArtifactInvalidGuidanceRule) Severity() string {
	return tflint.ERROR
}
		...
		return runner.EnsureNoError(err, func() error {
			...
			if !found {
				runner.EmitIssueOnExpr(
					r,
					fmt.Sprintf(`"%s" is an invalid value as guidance`, truncateLongMessage(val)),
					attribute.Expr,
				)
			}
			return nil
