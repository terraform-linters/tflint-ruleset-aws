...
// NewAwsServicecatalogProductInvalidTagsRule returns new rule with default attributes
func NewAwsServicecatalogProductInvalidTagsRule() *AwsServicecatalogProductInvalidTagsRule {
	return &AwsServicecatalogProductInvalidTagsRule{
...
func (r *AwsServicecatalogProductInvalidTagsRule) Name() string {
	return "aws_servicecatalog_product_invalid_tags"
}

// Enabled returns whether the rule is enabled by default
func (r *AwsServicecatalogProductInvalidTagsRule) Enabled() bool {
	return true
}

// Severity returns the rule severity
func (r *AwsServicecatalogProductInvalidTagsRule) Severity() tflint.Severity {
	return tflint.ERROR
}

// Link returns the rule reference link
func (r *AwsServicecatalogProductInvalidTagsRule) Link() string {
	return ""
}
