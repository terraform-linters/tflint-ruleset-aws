...
func NewAwsImagebuilderImageRecipeInvalidDescriptionRule() *AwsImagebuilderImageRecipeInvalidDescriptionRule {
	return &AwsImagebuilderImageRecipeInvalidDescriptionRule{
...
func (r *AwsImagebuilderImageRecipeInvalidDescriptionRule) Name() string {
	return "aws_imagebuilder_image_recipe_invalid_description"
}
...
func (r *AwsImagebuilderImageRecipeInvalidDescriptionRule) Severity() string {
	return tflint.ERROR
}
