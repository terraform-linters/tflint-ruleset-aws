...
// AwsLambdaFunctionInvalidTagsRule validates map keys and values
type AwsLambdaFunctionInvalidTagsRule struct {
	tflint.DefaultRule
...
// NewAwsLambdaFunctionInvalidTagsRule returns new rule with default attributes
func NewAwsLambdaFunctionInvalidTagsRule() *AwsLambdaFunctionInvalidTagsRule {
	return &AwsLambdaFunctionInvalidTagsRule{
...
func (r *AwsLambdaFunctionInvalidTagsRule) Name() string {
	return "aws_lambda_function_invalid_tags"
}

// Enabled returns whether the rule is enabled by default
func (r *AwsLambdaFunctionInvalidTagsRule) Enabled() bool {
	return true
}

// Severity returns the rule severity
func (r *AwsLambdaFunctionInvalidTagsRule) Severity() tflint.Severity {
	return tflint.ERROR
}

// Link returns the rule reference link
func (r *AwsLambdaFunctionInvalidTagsRule) Link() string {
	return ""
}

// Check validates map keys and values
func (r *AwsLambdaFunctionInvalidTagsRule) Check(runner tflint.Runner) error {
