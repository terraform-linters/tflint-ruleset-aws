...
func NewAwsServicecatalogServiceActionInvalidDescriptionRule() *AwsServicecatalogServiceActionInvalidDescriptionRule {
	return &AwsServicecatalogServiceActionInvalidDescriptionRule{
...
func (r *AwsServicecatalogServiceActionInvalidDescriptionRule) Name() string {
	return "aws_servicecatalog_service_action_invalid_description"
}
...
func (r *AwsServicecatalogServiceActionInvalidDescriptionRule) Severity() string {
	return tflint.ERROR
}
