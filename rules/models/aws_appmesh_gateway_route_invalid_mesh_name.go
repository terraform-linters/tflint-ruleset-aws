...
func NewAwsAppmeshGatewayRouteInvalidMeshNameRule() *AwsAppmeshGatewayRouteInvalidMeshNameRule {
	return &AwsAppmeshGatewayRouteInvalidMeshNameRule{
...
func (r *AwsAppmeshGatewayRouteInvalidMeshNameRule) Name() string {
	return "aws_appmesh_gateway_route_invalid_mesh_name"
}
...
func (r *AwsAppmeshGatewayRouteInvalidMeshNameRule) Severity() string {
	return tflint.ERROR
}
