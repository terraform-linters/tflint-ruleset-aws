...
func NewAwsConnectLambdaFunctionAssociationInvalidInstanceIDRule() *AwsConnectLambdaFunctionAssociationInvalidInstanceIDRule {
	return &AwsConnectLambdaFunctionAssociationInvalidInstanceIDRule{
...
func (r *AwsConnectLambdaFunctionAssociationInvalidInstanceIDRule) Name() string {
	return "aws_connect_lambda_function_association_invalid_instance_id"
}
...
func (r *AwsConnectLambdaFunctionAssociationInvalidInstanceIDRule) Severity() string {
	return tflint.ERROR
}
