...
// AwsEcsClusterInvalidTagsRule validates map keys and values
type AwsEcsClusterInvalidTagsRule struct {
	tflint.DefaultRule
...
// NewAwsEcsClusterInvalidTagsRule returns new rule with default attributes
func NewAwsEcsClusterInvalidTagsRule() *AwsEcsClusterInvalidTagsRule {
	return &AwsEcsClusterInvalidTagsRule{
...
func (r *AwsEcsClusterInvalidTagsRule) Name() string {
	return "aws_ecs_cluster_invalid_tags"
}

// Enabled returns whether the rule is enabled by default
func (r *AwsEcsClusterInvalidTagsRule) Enabled() bool {
	return true
}

// Severity returns the rule severity
func (r *AwsEcsClusterInvalidTagsRule) Severity() tflint.Severity {
	return tflint.ERROR
}

// Link returns the rule reference link
func (r *AwsEcsClusterInvalidTagsRule) Link() string {
	return ""
}

// Check validates map keys and values
func (r *AwsEcsClusterInvalidTagsRule) Check(runner tflint.Runner) error {
