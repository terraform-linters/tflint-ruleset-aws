...
// AwsSsoadminPermissionSetInvalidTagsRule validates map keys and values
type AwsSsoadminPermissionSetInvalidTagsRule struct {
	tflint.DefaultRule
...
// NewAwsSsoadminPermissionSetInvalidTagsRule returns new rule with default attributes
func NewAwsSsoadminPermissionSetInvalidTagsRule() *AwsSsoadminPermissionSetInvalidTagsRule {
...
func (r *AwsSsoadminPermissionSetInvalidTagsRule) Name() string {
	return "aws_ssoadmin_permission_set_invalid_tags"
}

// Enabled returns whether the rule is enabled by default
func (r *AwsSsoadminPermissionSetInvalidTagsRule) Enabled() bool {
	return true
}

// Severity returns the rule severity
func (r *AwsSsoadminPermissionSetInvalidTagsRule) Severity() tflint.Severity {
	return tflint.ERROR
}

// Link returns the rule reference link
func (r *AwsSsoadminPermissionSetInvalidTagsRule) Link() string {
	return ""
}

// Check validates map keys and values
func (r *AwsSsoadminPermissionSetInvalidTagsRule) Check(runner tflint.Runner) error {
