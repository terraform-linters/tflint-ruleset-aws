...
func NewAwsFsxOntapFileSystemInvalidWeeklyMaintenanceStartTimeRule() *AwsFsxOntapFileSystemInvalidWeeklyMaintenanceStartTimeRule {
	return &AwsFsxOntapFileSystemInvalidWeeklyMaintenanceStartTimeRule{
...
func (r *AwsFsxOntapFileSystemInvalidWeeklyMaintenanceStartTimeRule) Name() string {
	return "aws_fsx_ontap_file_system_invalid_weekly_maintenance_start_time"
}
...
func (r *AwsFsxOntapFileSystemInvalidWeeklyMaintenanceStartTimeRule) Severity() string {
	return tflint.ERROR
}
