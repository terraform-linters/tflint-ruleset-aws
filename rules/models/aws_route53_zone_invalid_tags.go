...
// NewAwsRoute53ZoneInvalidTagsRule returns new rule with default attributes
func NewAwsRoute53ZoneInvalidTagsRule() *AwsRoute53ZoneInvalidTagsRule {
	return &AwsRoute53ZoneInvalidTagsRule{
...
func (r *AwsRoute53ZoneInvalidTagsRule) Name() string {
	return "aws_route53_zone_invalid_tags"
}

// Enabled returns whether the rule is enabled by default
func (r *AwsRoute53ZoneInvalidTagsRule) Enabled() bool {
	return true
}

// Severity returns the rule severity
func (r *AwsRoute53ZoneInvalidTagsRule) Severity() tflint.Severity {
	return tflint.ERROR
}

// Link returns the rule reference link
func (r *AwsRoute53ZoneInvalidTagsRule) Link() string {
	return ""
}
